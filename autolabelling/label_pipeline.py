...
"""
Auto-Labelling Pipeline 2: Caption/Detailed Caption/More Detailed Caption + Phrase Grounding + Segmentation
"""
def caption_phrase_grounding_and_detection_falcon_SAM(
    falcon_vllm_model,
    falcon_vllm_processor,
    single_ceiling_image_path, 
    sam_predictor,
    specific_task_prompt,
    output_dir
):
"""
A pipeline for automatically labelling a single ceiling/architure image

Args:
    falcon_vllm_model: falcon-vllm model
    falcon_vllm_processor: falcon-vllm processor
    single_ceiling_image_path: path to a single ceiling/architure image
    sam_predictor: initialized SAM predictor
    specific_task_prompt: a specific task prompt for the given image
